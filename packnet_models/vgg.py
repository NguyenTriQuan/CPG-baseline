...
def vgg16_bn_10_mini_imagenet(pretrained=False, dataset_history=[], dataset2num_classes={}, **kwargs):
    ...
    if pretrained:
        kwargs['init_weights'] = False
    return VGG(make_layers_10_mini_imagenet(cfg['D'], batch_norm=True), dataset_history, dataset2num_classes, N=2048, **kwargs)
...
def vgg16_bn_20_mini_imagenet(pretrained=False, dataset_history=[], dataset2num_classes={}, **kwargs):
    ...
    if pretrained:
        kwargs['init_weights'] = False
    return VGG(make_layers_20_mini_imagenet(cfg['D'], batch_norm=True), dataset_history, dataset2num_classes, N=4096, **kwargs)