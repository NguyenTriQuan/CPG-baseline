...
def get(args, pc_valid=0.10):
    ...
    test_loader = DataLoader(TensorDataset(images, labels), batch_size=args.val_batch_size, shuffle=False)
    ...
    return train_loader, test_loader, train_transform, valid_transform
