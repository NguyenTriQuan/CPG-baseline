...
class Manager(object):
    ...
    def __init__(self, args, model, shared_layer_info, masks, train_loader, val_loader, train_transform, valid_transform, begin_prune_step, end_prune_step):
        self.args = args
        self.model = model
    ...
    def train(self, optimizers, epoch_idx, curr_lrs, curr_prune_step):
        ...
        with tqdm(total=len(self.train_loader),
            ...
            for batch_idx, (data, target) in enumerate(self.train_loader):
                ...
                print(data.device, output.device, target.device)
                num = data.size(0)
