...
import utils.mini_imagenet_dataset as dataset
import models
...
def main():
    ...
    #     sys.exit(1)
    train_loader, val_loader, train_transform, valid_transform = dataset.get(args)
    ...
    manager = Manager(args, model, shared_layer_info, masks, train_loader, val_loader, train_transform, valid_transform, begin_prune_step, end_prune_step)
